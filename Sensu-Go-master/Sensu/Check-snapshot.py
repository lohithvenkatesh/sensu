          ...
          for v in vols:
              ...
              for snap in snapshots:
                  ...
                  if created_on <= deletion_date and can_delete == True:
                      ...
                      snap.delete()
                      deletion_counter += 1
                      print('   Made {0} snapshots totalling {1} GB Deleted {2} snapshots totalling {3} GB'.format(snapshot_counter, snap_size_counter, deletion_counter, deleted_size_counter))
                      return